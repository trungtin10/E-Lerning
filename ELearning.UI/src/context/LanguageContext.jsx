...
const translations = {
  vi: {
    ...
    courseCompleted: 'Đã hoàn thành khóa học',
    courseInProgress: 'Đang trong quá trình học',
    detailedProgress: 'Chi tiết từng bài giảng',
    lessonTitle: 'Tiêu đề bài học',
    completionTime: 'Thời gian xong',
    notStarted: 'Chưa học',
    status: 'Trạng thái',
  },
  en: {
    ...
    detailedProgress: 'Detailed Lesson Progress',
